...
export const domBuilderMethods = {
  ...
  _build() {
    ...
    this.folderInput = el('input', { type: 'file', webkitdirectory: '', multiple: '', tabindex: '0', style: 'position:absolute;left:0;top:0;clip:rect(0,0,0,0);clip-path:inset(50%);height:1px;width:1px;overflow:hidden', id: 'folderInput' })
  ...
  _buildControlBar() {
    ...
    const row = el('div', { class: 'media-controls-row' }, [
      ...
      this.btnSub = this._ctrlBtn('subtitle', 'subtitle', '字幕', 'subtitle', false),
      this.btnPip = this._ctrlBtn('pip', 'pip', '画中画', 'pip', false),
      this.btnShot = this._ctrlBtn('capture', 'camera', '截图', 'capture', false),
      this.btnZoomIn = this._ctrlBtn('zoom-in', 'zoomIn', '放大', 'zoom-in', false),
      this.btnZoomOut = this._ctrlBtn('zoom-out', 'zoomOut', '缩小', 'zoom-out', false),
